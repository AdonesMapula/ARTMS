    ...
    <>
      <style>{`
        .toast-gradient-border {
          ...
          background-image: linear-gradient(#ffffff, #ffffff), linear-gradient(to right, #111A62, #E15B1D) !important;
          background-origin: padding-box, border-box !important;
          background-clip: padding-box, border-box !important;
        }
        .dark .toast-gradient-border {
          background-image: linear-gradient(#0F163D, #0F163D), linear-gradient(to right, #111A62, #E15B1D) !important;
        }
      `}</style>
      <Sonner
        theme={theme}
        ...
        toastOptions={{
          classNames: {
            toast:
              "group toast toast-gradient-border group-[.toaster]:bg-white group-[.toaster]:text-slate-950 group-[.toaster]:shadow-xl group-[.toaster]:rounded-2xl dark:group-[.toaster]:bg-[#0F163D] dark:group-[.toaster]:text-slate-50 dark:group-[.toaster]:shadow-2xl font-sans text-sm py-3.5 px-4 gap-3",
            title:
