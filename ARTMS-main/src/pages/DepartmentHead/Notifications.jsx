        ...
        <div className="p-6">
          {loading ? (
            <div className="flex flex-col items-center justify-center py-16 text-slate-400 gap-3">
              <span className="h-8 w-8 animate-spin rounded-full border-2 border-slate-300 border-t-[#111A62]" />
              <p className="text-xs font-semibold tracking-wide">Retrieving department alerts...</p>
            </div>
