...
<head>
  <meta charset="utf-8">
  <title>Login Verification Code — ARTMS</title>
</head>
...
<div style="max-width:600px;margin:32px auto;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
  ...
  <div style="padding:36px 40px;">
    ...
    <p style="margin:0 0 20px;font-size:15px;color:#374151;line-height:1.6;">
      A sign-in attempt was initiated for your ARTMS account. Please use the following 6-digit verification code to complete your login:
    </p>

    {{-- OTP Display Box --}}
    <div style="background:#f8fafc;border:2px dashed #94a3b8;border-radius:12px;padding:24px;text-align:center;margin:24px 0;">
      <span style="font-size:42px;font-weight:800;letter-spacing:0.25em;color:#060F5A;font-family:monospace;">
        {{ $otp }}
      </span>
    </div>
    ...
    <div style="margin-top:20px;padding:14px 18px;background:#fef2f2;border-left:4px solid #ef4444;border-radius:6px;">
      <p style="margin:0;font-size:13px;color:#991b1b;line-height:1.5;">
        <strong>Security Notice:</strong> If you did not initiate this sign-in attempt, someone may know your password. Please immediately secure your account or contact your system administrator.
      </p>
    </div>
