...
class ManpowerRequestController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        // Dispatch real-time in-app + email notifications to relevant approvers (COO)
    ...
    public function approve(Request $request, ManpowerRequest $manpowerRequest): JsonResponse
    {
        ...
        // Send notifications based on the new status to targeted stakeholders
        if ($data['status'] === 'approved') {
            $recipients = NotificationRecipientResolver::resolve('manpower_request.approved', $manpowerRequest, $request->user());
            NotificationService::notifyRecipients(
                $recipients,
            ...
            $rem = !empty($data['remarks']) ? " Remarks: {$data['remarks']}" : "";
            $recipients = NotificationRecipientResolver::resolve('manpower_request.rejected', $manpowerRequest, $request->user());
            NotificationService::notifyRecipients(
                $recipients,
            ...
            $recipients = NotificationRecipientResolver::resolve('manpower_request.revised', $manpowerRequest, $request->user());
            NotificationService::notifyRecipients(
                $recipients,
